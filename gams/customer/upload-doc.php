...
$docs=md5($docs).time().$extension;
 move_uploaded_file($_FILES["docs"]["tmp_name"],"images/".$docs);
  $sql="update tblconnection set Documents=:docs where ID=:eid";
...
<head>
    ...
    <title>Update Documents | Gas Agency Management System</title>
...
{               ?>
                                                    <div class="form-group-inner">
                                                     ...
                                                     <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Upload Document(ID Proof and Address proof)</label>
                                                            </div>
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <img src="images/<?php echo $row->Documents;?>" width="200" height="150" value="<?php  echo $row->Documents;?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">New Upload Document(ID Proof and Address proof)</label>
                                                            </div>
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <input type="file" class="form-control" id="" name="docs" value="" required='true'>
                                                            </div>
                                                        </div>
                                                    </div>
