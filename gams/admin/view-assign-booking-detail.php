...
$sql= "update tblbooking set Status=:status,Remark=:remark where ID=:vid";
$query=$dbh->prepare($sql);
$query->bindParam(':status',$status,PDO::PARAM_STR);
$query->bindParam(':remark',$remark,PDO::PARAM_STR);
...
<head>
    ...
    <title>View Booking Details | Gas Agency Management System</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">View Assign Booking Detail</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="sparkline12-list">
                            <div class="sparkline12-hd">
                                <div class="main-sparkline12-hd">
                                    <h1>View Assign Booking Detail</h1>
                                </div>
                            </div>
...
if ($status=="Confirmed" || $status=="On The Way"){
?> 
<p align="center">                            
