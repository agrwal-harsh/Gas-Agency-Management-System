...
$ret="select Email from tblstaff where Email=:email || MobileNumber=:mobnum || StaffID=:staffid";
...
$sql="insert into tblstaff(StaffID,Name,MobileNumber,Email,Address,Password)values(:staffid,:name,:mobnum,:email,:address,:password)";
...
echo "<script>alert('Email-id,Staff Id or Mobile Number already exist. Please try again');</script>";
}
}
...
<head>
    ...
    <title>Add Staff | Gas Agency Management System</title>
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                 <input type="text" class="form-control" name="staffid" value="" required='true'>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
