...
<head>
    ...
    <title>Change Password | Gas Agency Management System</title>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="login-horizental cancel-wp pull-left form-bc-ele">
                                                                        ...
                                                                        <button class="btn btn-sm btn-primary login-submit-cs" type="submit"name="submit">Change</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
