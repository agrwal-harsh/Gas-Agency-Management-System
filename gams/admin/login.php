...
<head>
    ...
    <title>Login | Gas Agency Managemnt System</title>
	...
	<div class="error-pagewrap">
		<div class="error-page-int">
			<div class="text-center m-b-md custom-login">
				<h3>PLEASE LOGIN TO ADMIN PANEL</h3>
                    ...
                    <div class="panel-body">
                        <form action="#" id="loginForm" method="post">
                            ...
                            <div class="checkbox login-checkbox">
                                <label>
										<input type="checkbox" class="i-checks" id="remember" name="remember" <?php if(isset($_COOKIE["user_login"])) { ?> checked <?php } ?> /> Remember me </label>
