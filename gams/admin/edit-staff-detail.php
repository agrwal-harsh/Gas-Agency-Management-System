...
$sql="update tblstaff set Name=:name,MobileNumber=:mobnum,Email=:email,Address=:address where ID=:eid";
...
<head>
    ...
    <title>Update Staff Detail | Gas Agency Management System</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Update Staff Detail</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                 <input type="text" class="form-control" name="staffid" value="<?php  echo htmlentities($row->StaffID);?>" readonly='true'>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
